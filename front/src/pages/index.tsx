    ...
    <>
      ...
      <section className="section" id="services">
        ...
        <p>
          ...
          <strong><a style={{color: "inherit", textDecoration: "underline"}}
                     href="mailto:info@tecsiz.co.jp">まずはご相談ください。</a></strong>
        </p>
      </section>
      ...
      <section className="section" id="tech">
        ...
        <div>
          ...
          <p>
            ...
            Echo・Gin（Go） / Laravel・CakePHP（PHP） / Ruby on Rails（Ruby） / FastAPI・Django（Python） / Spring Boot（Java） /
            Vue.js・React・Next.js（JavaScript/TypeScript）
          </p>
      ...
      <section className="section" id="recruit">
        ...
        <h3>募集ポジション</h3>
        <ul>
          <li>エンジニア（バックエンド / フロントエンド / インフラなど分野不問、未経験者も歓迎）</li>
        </ul>

        <h3>主な業務内容</h3>
        <p>
          プロジェクトにより、リモート勤務・社内開発・クライアント先での常駐など柔軟な働き方があります。
        </p>

        <h3>歓迎するスキル・志向</h3>
        <ul>
          <li>Go / Python / React / Vue / AWS などの技術経験</li>
          <li>新しい技術を学び、実務に活かす意欲</li>
          <li>チームでの開発や協働に前向きな姿勢</li>
        </ul>
