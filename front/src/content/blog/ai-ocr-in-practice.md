...
もう一つ、検討の前に確認しておきたいのが**対象がスキャン画像のPDFなのか、テキストが埋め込まれたPDFなのか**です。後者ならOCRもLLMも使わずにテキスト抽出だけで済み、コストも精度も有利になります。詳しくは[そのPDF、AI OCRいらないかもしれません](/blog/text-pdf-does-not-need-ai-ocr/)に書きました。
