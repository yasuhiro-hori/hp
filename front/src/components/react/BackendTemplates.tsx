                ...
                {backendType === 'go' ? (
                    <>
                        <div>
                            ...
                            <p style={{ fontSize: '1.1rem', color: 'var(--text-color)', marginBottom: '1.5rem', fontWeight: 'bold' }}>
                                10年戦える<br />
                                技術的負債を生まない堅牢な設計
                            </p>
                            ...
                            <div>
                                <h4 style={{ marginBottom: '1rem', color: 'var(--text-color)' }}>Key Features</h4>
                                <ul style={{ listStyle: 'none', padding: 0 }}>
                                    <li style={{ marginBottom: '0.8rem', display: 'flex', alignItems: 'center', color: 'var(--text-secondary)' }}>
                        ...
                        <div className="arch-container" style={{ background: '#f8fafc', padding: '2rem', borderRadius: '1rem', border: '1px solid var(--card-border)' }}>
                            <div style={{ textAlign: 'center', marginBottom: '1.5rem', color: 'var(--text-secondary)', fontSize: '0.95rem', fontFamily: 'monospace', letterSpacing: '0.05em' }}>
                            ...
                            <div style={{ position: 'relative', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <div style={{ position: 'absolute', width: '100%', height: '100%', borderRadius: '50%', border: '2px dashed #cbd5e1', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', paddingTop: '10px' }}>
                                    <span style={{ background: '#f8fafc', padding: '0 5px', color: '#64748b', fontSize: '0.8rem' }}>Infrastructure</span>
                                </div>
                                <div style={{ position: 'absolute', width: '80%', height: '80%', borderRadius: '50%', border: '2px solid #3b82f6', background: 'rgba(59, 130, 246, 0.05)', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', paddingTop: '10px' }}>
                                    <span style={{ color: '#1d4ed8', fontWeight: 'bold', fontSize: '0.9rem', marginTop: '0' }}>Adapters</span>
                                </div>
                                <div style={{ position: 'absolute', width: '60%', height: '60%', borderRadius: '50%', border: '2px solid #8b5cf6', background: 'rgba(139, 92, 246, 0.05)', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', paddingTop: '10px' }}>
                                    <span style={{ color: '#6d28d9', fontWeight: 'bold', fontSize: '0.9rem', marginTop: '5px' }}>Usecases</span>
                                </div>
                                <div style={{ position: 'absolute', width: '35%', height: '35%', borderRadius: '50%', background: '#10b981', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 10px 25px -5px rgba(16, 185, 129, 0.4)' }}>
                                    <span style={{ color: '#fff', fontWeight: 'bold' }}>Domain</span>
                                </div>
                            </div>
                        </div>
                    </>
                        ...
                        <div className="arch-container" style={{ background: '#f8fafc', padding: '2rem', borderRadius: '1rem', border: '1px solid var(--card-border)' }}>
                            ...
                            <div style={{ position: 'relative', height: '300px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                ...
                                <div style={{ position: 'absolute', width: '80%', height: '80%', borderRadius: '50%', border: '2px solid #ef4444', background: 'rgba(239, 68, 68, 0.05)', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', paddingTop: '10px' }}>
                                    <span style={{ color: '#b91c1c', fontWeight: 'bold', fontSize: '0.9rem', marginTop: '0' }}>Adapters</span>
                                </div>
                                <div style={{ position: 'absolute', width: '60%', height: '60%', borderRadius: '50%', border: '2px solid #f97316', background: 'rgba(249, 115, 22, 0.05)', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', paddingTop: '10px' }}>
                                    <span style={{ color: '#c2410c', fontWeight: 'bold', fontSize: '0.9rem', marginTop: '5px' }}>Usecases</span>
                                </div>
                                <div style={{ position: 'absolute', width: '35%', height: '35%', borderRadius: '50%', background: '#dea584', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 10px 25px -5px rgba(222, 165, 132, 0.4)' }}>
                                    <span style={{ color: '#fff', fontWeight: 'bold' }}>Domain</span>
                                </div>
                            </div>
                        </div>
